	...
	<div class="wrapper">
		...
		<div class="page-wrap">
			...
			<div class="main-content">
				<div class="col-md-12" style="margin: auto; max-width: 85%; margin-top: 50px;">
					<div class="card">
					                ...
					                <ul class="pagination">
						                	...
						                	<c:choose>
												<c:when test="${ pi.currentPage eq p}">
							                    	<li class="pageNo selected"><a href="list.bo?cpage=${ p }">${ p }</a></li>
												</c:when>
												<c:otherwise>
							                    	<li class="pageNo"><a href="list.bo?cpage=${ p }">${ p }</a></li>
												</c:otherwise>
						               		</c:choose>
					                   	</c:forEach>
					                </ul>
