      ...
      <div class="sidebar-content">
        <div class="nav-container">
          <nav id="main-menu-navigation" class="navigation-main">
            <div class="nav-item">
              <a href="acountBook.ac"><i class="ik ik-menu"></i><span>가계부</span></a>
            </div>
            <div class="nav-item">
              <a href="list.bo"
            ...
            <div class="nav-item has-sub">
              ...
              <div class="submenu-content">
                <a href="resources/pages/ui/alerts.html" class="menu-item"
                  >Alerts</a
                >
                <a href="resources/pages/ui/badges.html" class="menu-item"
                  >Badges</a
                >
                <a href="resources/pages/ui/buttons.html" class="menu-item"
                  >Buttons</a
                >
                <a href="resources/pages/ui/navigation.html" class="menu-item"
                  >Navigation</a
                >
              </div>
            </div>
            <div class="nav-item has-sub">
              ...
              <div class="submenu-content">
                ...
                <a
                  href="resources/pages/ui/notifications.html"
                  class="menu-item"
                  >Notifications</a
                >
                <a href="resources/pages/ui/carousel.html" class="menu-item"
                  >Slider</a
                >
                <a href="resources/pages/ui/range-slider.html" class="menu-item"
                  >Range Slider</a
                >
                <a href="resources/pages/ui/rating.html" class="menu-item"
                  >Rating</a
                >
              </div>
            </div>
            <div class="nav-item has-sub">
              ...
              <div class="submenu-content">
                <a
                  href="resources/pages/ui/session-timeout.html"
                  class="menu-item"
                  >Session Timeout</a
                >
              </div>
            ...
            <div class="nav-item">
              <a href="resources/pages/ui/icons.html"
                ><i class="ik ik-command"></i><span>환율</span></a
              >
            </div>
            <div class="nav-item">
              <a href="aichat.ac"
                ><i class="ik ik-menu"></i><span>AI 문의</span>
              </a>
            </div>
          </nav>
        </div>
