    ...
    <div class="wrapper">
      ...
      <div class="page-wrap">
        ...
        <div class="main-content">
          ...
          <div class="card-body">
            <form action="findPwd.2" method="post">
			  <div class="form-group">
			    <label for="exampleInputUsername">본인의 아이디를 입력해주세요.</label>
			    <input type="text" class="form-control" id="name" name="memId" placeholder="아이디를 입력해주세요." required />
			  </div>
