                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item">
                                    <a href="resources/pages/ui/icons.html"><i class="ik ik-command"></i><span>Icons</span></a>
                                </div>
                                <div class="nav-lavel">Forms</div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-edit"></i><span>Forms</span></a>
                                    <div class="submenu-content">
                                        <a href="resources/pages/form-components.html" class="menu-item">Components</a>
                                        <a href="resources/pages/form-addon.html" class="menu-item">Add-On</a>
                                        <a href="resources/pages/form-advance.html" class="menu-item">Advance</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="resources/pages/form-picker.html"><i class="ik ik-terminal"></i><span>Form Picker</span> <span class="badge badge-success">New</span></a>
                                </div>

                                <div class="nav-lavel">Tables</div>
                                <div class="nav-item">
                                    <a href="resources/pages/table-bootstrap.html"><i class="ik ik-credit-card"></i><span>Bootstrap Table</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="resources/pages/table-datatable.html"><i class="ik ik-inbox"></i><span>Data Table</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="resources/pages/charts-chartist.html" class="menu-item active">Chartist</a>
                                        <a href="resources/pages/charts-flot.html" class="menu-item">Flot</a>
                                        <a href="resources/pages/charts-knob.html" class="menu-item">Knob</a>
                                        <a href="resources/pages/charts-amcharts.html" class="menu-item">Amcharts</a>
                                    </div>
                                </div>

                                <div class="nav-lavel">Apps</div>
                                <div class="nav-item">
                                    <a href="resources/pages/calendar.html"><i class="ik ik-calendar"></i><span>Calendar</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="resources/pages/taskboard.html"><i class="ik ik-server"></i><span>Taskboard</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="resources/pages/login.html" class="menu-item">Login</a>
                                        <a href="resources/pages/register.html" class="menu-item">Register</a>
                                        <a href="resources/pages/forgot-password.html" class="menu-item">Forgot Password</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-file-text"></i><span>Other</span></a>
                                    <div class="submenu-content">
                                        <a href="resources/pages/profile.html" class="menu-item">Profile</a>
                                        <a href="resources/pages/invoice.html" class="menu-item">Invoice</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="resources/pages/layouts.html"><i class="ik ik-layout"></i><span>Layouts</span><span class="badge badge-success">New</span></a>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body chat-box scrollable" style="height:300px;">
                                        <ul class="chat-list">
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="resources/img/users/1.jpg" alt="user"></div>
                                            ...
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="resources/img/users/2.jpg" alt="user"></div>
                                                <div class="chat-content">
                                            ...
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="resources/img/users/3.jpg" alt="user"></div>
                                                <div class="chat-content">
                            ...
                            <div class="col-md-4">
                                <div class="card" style="min-height: 422px;">
                                    ...
                                    <div class="card-body timeline">
                                        <div class="header bg-theme" style="background-image: url('resources/img/placeholder/placeimg_400_200_nature.jpg')">
                                ...
                                <table id="advanced_table" class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><img src="resources/img/users/1.jpg" class="table-user-thumb" alt=""></td>
                                            <td>Tiger Nixon</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="resources/img/users/2.jpg" class="table-user-thumb" alt=""></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="resources/img/users/3.jpg" class="table-user-thumb" alt=""></td>
                                            <td>Ashton Cox</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="resources/img/users/4.jpg" class="table-user-thumb" alt=""></td>
                                            <td>Cedric Kelly</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="resources/img/users/5.jpg" class="table-user-thumb" alt=""></td>
                                            <td>Airi Satou</td>
                                            <td>Accountant</td>
                                            <td>Tokyo</td>
                                            <td>33</td>
